...
import '../class/delete_class.dart';
import '../department/create_department.dart';
import '../department/delete_department.dart';
import '../links/delete_prof_course.dart';
import '../links/delete_prof_course_class.dart';
import '../links/link_prof_course.dart';
import '../links/link_prof_course_class.dart';
import '../student/add_students_excel.dart';
...
class ProfessorHomeScreen extends StatefulWidget {
  ...
  @override
  ProfessorHomeScreenState createState() => ProfessorHomeScreenState();
}

class ProfessorHomeScreenState extends State<ProfessorHomeScreen> {
